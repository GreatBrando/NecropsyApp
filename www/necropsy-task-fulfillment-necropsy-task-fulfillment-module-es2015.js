...
let NecropsyTaskFulfillmentPageRoutingModule = class NecropsyTaskFulfillmentPageRoutingModule {
};
...
let NecropsyTaskFulfillmentPageModule = class NecropsyTaskFulfillmentPageModule {
};
...
const { Camera, Filesystem } = _capacitor_core__WEBPACK_IMPORTED_MODULE_10__["Plugins"];
let NecropsyTaskFulfillmentPage = class NecropsyTaskFulfillmentPage {
    constructor(plt, file, fileOpener, alertCtrl, sanitizer, route, router, navCtrl, http) {
        this.plt = plt;
        this.file = file;
...
NecropsyTaskFulfillmentPage.ctorParameters = () => [
...
//# sourceMappingURL=necropsy-task-fulfillment-necropsy-task-fulfillment-module-es2015.js.map