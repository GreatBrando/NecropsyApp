...
var PathRequestPage = /** @class */ (function () {
    function PathRequestPage(alertCtrl, http, router, navCtrl) {
    ...
    PathRequestPage.prototype.loadData = function () {
        var _this = this;
        var data;
        data = this.http.get('http://10.136.137.223:18080/ords/pathlimsreports/v_nec_int_pathrequest/?limit=1000')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) { return response.items; })); // map to use the items key!
    ...
    PathRequestPage.prototype.initializeItems = function () {
        this.pathRequestFilter = this.items;
    };
    PathRequestPage.prototype.goToProcedureDetails = function (row) {
    ...
    PathRequestPage.prototype.filterItems = function (ev) {
        ...
        if (val && val.trim() != '') {
            this.pathRequestFilter = this.items.filter(function (item) {
    ...
    PathRequestPage.prototype.doRefresh = function (event) {
        this.loadData();
