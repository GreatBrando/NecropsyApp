...
let TaskFulfillmentPage = class TaskFulfillmentPage {
    constructor(modalController, navParams, plt, file, fileOpener, alertCtrl, sanitizer, route, router, navCtrl, http) {
    ...
    loadData() {
        ...
        data = this.http.get('http://10.136.137.223:18080/ords/pathlimsreports/v_nec_int_tissue/?q=%7B%22path_request_id%22:%22' + this.pathrequestid + '%22,%22procedure_id%22:' + this.procedureid + '%7D')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])((response) => response.items)); // map to use the items key!
        data.subscribe(data => {
            this.items = data;
...
TaskFulfillmentPage.ctorParameters = () => [
...
//# sourceMappingURL=default~animal-worklist-animal-worklist-module~modals-task-fulfillment-task-fulfillment-module-es2015.js.map