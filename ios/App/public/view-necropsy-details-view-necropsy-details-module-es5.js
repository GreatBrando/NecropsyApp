...
var ViewNecropsyDetailsPageRoutingModule = /** @class */ (function () {
    function ViewNecropsyDetailsPageRoutingModule() {
    }
    ...
    return ViewNecropsyDetailsPageRoutingModule;
}());
...
var ViewNecropsyDetailsPageModule = /** @class */ (function () {
    function ViewNecropsyDetailsPageModule() {
    }
    ...
    return ViewNecropsyDetailsPageModule;
}());
...
var ViewNecropsyDetailsPage = /** @class */ (function () {
    function ViewNecropsyDetailsPage(alertCtrl, http, route, router, navCtrl) {
    ...
    ViewNecropsyDetailsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            ...
            console.log(_this.pathrequestid);
            console.log(_this.procedureid);
            _this.loadData();
            _this.checkForUndefined();
        });
    };
    ViewNecropsyDetailsPage.prototype.switchStyle = function () {
    ...
    ViewNecropsyDetailsPage.prototype.loadData = function () {
        var _this = this;
        var data;
    ...
    ViewNecropsyDetailsPage.prototype.checkForUndefined = function () {
    ...
    ViewNecropsyDetailsPage.prototype.goToAnimalWorklist = function () {
    ...
    ViewNecropsyDetailsPage.prototype.goToProcedure = function () {
        var navigationExtras = {
            queryParams: {
                pathrequestid: this.pathrequestid,
                procedureid: this.procedureid,
    ...
    ViewNecropsyDetailsPage.prototype.doRefresh = function (event) {
        this.loadData();
        event.target.complete();
    };
    ViewNecropsyDetailsPage.ctorParameters = function () { return [
    ...
    return ViewNecropsyDetailsPage;
}());
...
//# sourceMappingURL=view-necropsy-details-view-necropsy-details-module-es5.js.map