...
var ViewNecropsyDetailsPage = /** @class */ (function () {
    function ViewNecropsyDetailsPage(alertCtrl) {
    ...
    ViewNecropsyDetailsPage.prototype.getRowClass = function (row) {
        if (!this.customRowClass) {
            return {};
        }
    };
    ViewNecropsyDetailsPage.prototype.open = function (row) {
